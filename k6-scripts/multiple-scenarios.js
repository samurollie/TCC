...
export async function openLinksScenario() {
  ...
  await page.goto("https://quickpizza.grafana.com/ru");
  await page.goto("https://quickpizza.grafana.com/de");
  await page.goto("https://quickpizza.grafana.com/page");
  await page.goto("https://quickpizza.grafana.com/ru/page");
  await page.goto("https://quickpizza.grafana.com/de/page");
